...
app.layout = html.Div([
    html.H1('Corona Virous Pandemic',style={'color':'#FF0000','text-align':'center'}),
    html.Div([
        html.Div([
            html.Div([
                html.Div([
...
@app.callback(Output('the_pie','figure'),[Input('my_dropdown','value')])

def gerated_graph(my_dropdown):
